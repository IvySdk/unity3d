...
__attribute__((deprecated("This class has been deprecated as of SDK 7.3.0. Please use "
                          "LevelPlayRewardedVideoDelegate instead.")))
...
/**
 ...
 @param available The new rewarded video availability. YES if available and ready to be shown, NO
 otherwise.
 */
- (void)rewardedVideoHasChangedAvailability:(BOOL)available
    __attribute__((deprecated("This API has been deprecated as of SDK 7.3.0. Please use the "
                              "alternate API in LevelPlayRewardedVideoDelegate instead.")));
