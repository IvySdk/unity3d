//
//  SDKCustomAlertView.m
//  SDKCustomAlertView
//
#import "SDKCustomAlertView.h"
#import <QuartzCore/QuartzCore.h>

const static CGFloat kSDKCustomAlertViewDefaultButtonHeight       = 50;
const static CGFloat kSDKCustomAlertViewDefaultButtonSpacerHeight = 1;
const static CGFloat kSDKCustomAlertViewCornerRadius              = 7;
const static CGFloat kCustomIOS7MotionEffectExtent                = 10.0;

@implementation SDKCustomAlertView
...
- (void)customIOS7dialogButtonTouchUpInside: (SDKCustomAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex
{
...
- (UIView *)createContainerView
{
    ...
    CGFloat cornerRadius = kSDKCustomAlertViewCornerRadius;
...
- (void)addButtonsToView: (UIView *)container
{
    ...
    for (int i=0; i<[buttonTitles count]; i++) {
        ...
        [closeButton.layer setCornerRadius:kSDKCustomAlertViewCornerRadius];
...
- (CGSize)countScreenSize
{
    if (buttonTitles!=NULL && [buttonTitles count] > 0) {
        buttonHeight       = kSDKCustomAlertViewDefaultButtonHeight;
        buttonSpacerHeight = kSDKCustomAlertViewDefaultButtonSpacerHeight;
    } else {
        buttonHeight = 0;
...
- (void)touchesEnded:(NSSet<UITouch *> *)touches withEvent:(UIEvent *)event {
    ...
    if ([touch.view isKindOfClass:[SDKCustomAlertView class]]) {
        [self close];
    }
}
