...
@implementation NSObject (SDKSwipeView)

- (CGSize)swipeViewItemSize:(__unused SDKSwipeView *)swipeView { return CGSizeZero; }
- (void)swipeViewDidScroll:(__unused SDKSwipeView *)swipeView {}
- (void)swipeViewCurrentItemIndexDidChange:(__unused SDKSwipeView *)swipeView {}
- (void)swipeViewWillBeginDragging:(__unused SDKSwipeView *)swipeView {}
- (void)swipeViewDidEndDragging:(__unused SDKSwipeView *)swipeView willDecelerate:(__unused BOOL)decelerate {}
- (void)swipeViewWillBeginDecelerating:(__unused SDKSwipeView *)swipeView {}
- (void)swipeViewDidEndDecelerating:(__unused SDKSwipeView *)swipeView {}
- (void)swipeViewDidEndScrollingAnimation:(__unused SDKSwipeView *)swipeView {}
- (BOOL)swipeView:(__unused SDKSwipeView *)swipeView shouldSelectItemAtIndex:(__unused NSInteger)index { return YES; }
- (void)swipeView:(__unused SDKSwipeView *)swipeView didSelectItemAtIndex:(__unused NSInteger)index {}

@end


@interface SDKSwipeView () <UIScrollViewDelegate, UIGestureRecognizerDelegate>
...
- (void)setDataSource:(id<SDKSwipeViewDataSource>)dataSource
{
...
- (void)setDelegate:(id<SDKSwipeViewDelegate>)delegate
{
...
- (void)setAlignment:(SDKSwipeViewAlignment)alignment
{
...
- (void)updateScrollViewDimensions
{
    ...
    switch (_alignment)
    {
        case SDKSwipeViewAlignmentCenter:
        {
            if (_vertical)
            {
        ...
        case SDKSwipeViewAlignmentEdge:
        {
            if (_vertical)
            {
...
- (CGFloat)offsetForItemAtIndex:(NSInteger)index
{
    ...
    if (_wrapEnabled)
    {
        if (_alignment == SDKSwipeViewAlignmentCenter)
        {
...
{
    //get number of items
    _numberOfItems = [_dataSource numberOfItemsInSDKSwipeView:self];
