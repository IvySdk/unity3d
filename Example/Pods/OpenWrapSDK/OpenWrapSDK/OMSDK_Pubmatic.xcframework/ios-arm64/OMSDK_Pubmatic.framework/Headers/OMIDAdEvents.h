 ...
 */
@interface OMIDPubmaticAdEvents : NSObject
 ...
 */
- (nullable instancetype)initWithAdSession:(nonnull OMIDPubmaticAdSession *)session error:(NSError * _Nullable * _Nullable)error;
 ...
 */
- (BOOL)loadedWithVastProperties:(OMIDPubmaticVASTProperties *_Nonnull)vastProperties
