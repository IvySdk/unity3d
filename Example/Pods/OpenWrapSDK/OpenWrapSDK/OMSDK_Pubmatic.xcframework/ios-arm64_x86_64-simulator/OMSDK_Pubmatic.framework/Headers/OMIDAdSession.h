 ...
 */
@interface OMIDPubmaticAdSession : NSObject

/**
 *  The AdSession configuration is used for check owners.
 */
@property(nonatomic, readonly) OMIDPubmaticAdSessionConfiguration *configuration;
/**
 ...
 */
- (nullable instancetype)initWithConfiguration:(OMIDPubmaticAdSessionConfiguration *)configuration
                              adSessionContext:(OMIDPubmaticAdSessionContext *)context
