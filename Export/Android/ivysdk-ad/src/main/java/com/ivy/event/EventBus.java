...
public class EventBus {
  ...
  public void fireEvent(int eventId, Object eventData) {
    ...
    if (listeners == null || listeners.isEmpty()) {
      Logger.debug( "No listeners to fire eventId= "+ Integer.valueOf(eventId) + " on");
      return;
    }
//    Logger.debug( "Firing eventId=%s on %s listeners", Integer.valueOf(eventId), Integer.valueOf(listeners.size()));
