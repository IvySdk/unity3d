...
public class ActivityPackage implements Serializable {
    ...
    // delay
    private Map<String, Object> partnerParameters;
    ...
    public void setPartnerParameters(Map<String, Object> partnerParameters) {
    ...
    public Map<String, Object> getPartnerParameters() {
    ...
    public String getExtendedString() {
        ...
        if (parameters != null) {
            ...
            SortedMap<String,Object> sortedParameters = new TreeMap<String,Object>(parameters);
