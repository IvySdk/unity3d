...
public class EventResponseData extends ResponseData {
    ...
    public EventResponseData(final ActivityPackage activityPackage) {
        this.eventToken = String.valueOf(activityPackage.getParameters().get("event_token"));
        this.callbackId = String.valueOf(activityPackage.getParameters().get("event_callback_id"));
