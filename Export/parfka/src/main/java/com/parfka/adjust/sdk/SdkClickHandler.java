...
public class SdkClickHandler implements ISdkClickHandler {
    ...
    private void sendSdkClickI(final ActivityPackage sdkClickPackage) {
        ...
        String source = String.valueOf(sdkClickPackage.getParameters().get("source"));
        boolean isReftag = source != null && source.equals(SOURCE_REFTAG);
        String rawReferrerString = String.valueOf(sdkClickPackage.getParameters().get("raw_referrer"));
        ...
        if (isInstallReferrer) {
            ...
            installReferrer = String.valueOf(sdkClickPackage.getParameters().get("referrer"));
        }
