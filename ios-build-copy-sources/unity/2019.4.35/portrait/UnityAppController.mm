...
{
    [[SDKFacade sharedInstance] application:application didReceiveRemoteNotification:userInfo fetchCompletionHandler handler];
    AppController_SendNotificationWithArg(kUnityDidReceiveRemoteNotification, userInfo);
    UnitySendRemoteNotification(userInfo);
    if (handler)
    {
...
#endif
{
    [[SDKFacade sharedInstance] application:application continueUserActivity:userActivity restorationHandler:restorationHandler];
...
- (BOOL)application:(UIApplication*)application didFinishLaunchingWithOptions:(NSDictionary*)launchOptions
{
    ...
    [self createUI];
    [self preStartUnity];
    //[[SDKFacade sharedInstance] setWindow:_window controller:_rootController];
